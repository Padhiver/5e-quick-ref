data_action = [
    ...
    },
    {
        ...
        icon: "crossed-swords",
        subtitle: "Attaque spéciale de corps à corps",
        description: "Vous tentez de désarmer une cible",
        reference: "DMG, pg. 271.",
        bullets: [
            "Vous pouvez utiliser votre <i>Action Attaquer</i> pour effectuer une attaque de corps à corps appelée, désarmer. Si vous avez plusieurs attaques avec l'action attaquer, cette attaque spéciale compte pour une d'elles.",
            "Vous êtes désavantagé lors du jet d'attaque si la cible tient l'objet visé à deux mains.",
			"Vous êtes désavantagé si la cible est d'une catégorie de taille de plus que vous.",
            "La cible est désavantagée si elle est d'une catégorie de taille inférieure à la votre.",
    ...
    },
	{
    ...
    },
	 {
        ...
        description: "Vous tentez de monter sur une créature plus grande",
        reference: "DMG, pg. 271.",
        bullets: [
            "Vous pouvez effectuer un test de Force (Athlétisme) ou de Dextérité (Acrobatie) en opposition à une cible appartenant à une catégorie de taille supérieure à la votre afin de vous accrocher à elle.",
			"En cas de réussite, vous entrez dans l'espace de la cible et vous déplacez avec elle. Vos jets d'attaques contre la cible sont avantagés.",
			"La capacité de la créature montée à vous attaquer est déterminée par le MJ et prend en compte votre positionnement sur cette dernière.",
			"Une fois en position, vous pouvez vous déplacer sur votre cible en la traitant comme un terrain difficile.",
        ...
        description: "Empêche une créature mourante de faire des jets de sauvegarde contre la mort.",
        reference: "PHB, pg. 197.",
        bullets: [
            "Faite un test de Sagesse (Médecine) DD 10",
            "En cas de succès, la créature est stable et n'a plus besoin de faire de jet de sauvegarde contre la mort.",
